package gay.nns.client.ui.clickgui;
...
public class GuiClick extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        UtilCustomFontRenderer robotoSmall = UtilFont.menuFont;
        UtilCustomFontRenderer robotoSmallBold = UtilFont.menuFontBold;
                ...
                if (mouseButton == 1) {
                    ...
                    for (Setting<?, ?> setting : SupremacyCore.getSingleton().getSettingManager().getSettingsFromType(m.getClass())) {
                        if (setting instanceof SettingMode) {
                            SettingMode settingMode = (SettingMode) setting;
                        ...
                        if (setting instanceof SettingBoolean) {
                            SettingBoolean settingCheckBox = (SettingBoolean) setting;
                            comps.add(new CompCheckBox(this, m, settingCheckBox));
                        }
                        if (setting instanceof SettingColor) {
                            SettingColor settingColor = (SettingColor) setting;
