...
public class UtilMicrosoftLogin {
    ...
    public static void getRefreshToken(final Consumer<String> callback) {
        UtilMicrosoftLogin.callback = callback;
    ...
    public static LoginData login(String refreshToken) {
        ...
        final AuthTokenResponse res = gson.fromJson(
                UtilBrowser.postExternal("https://login.live.com/oauth20_token.srf", "client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET + "&refresh_token=" + refreshToken + "&grant_type=refresh_token&redirect_uri=http://localhost:" + PORT, false),
        ...
        final XblXstsResponse xblRes = gson.fromJson(
                UtilBrowser.postExternal("https://user.auth.xboxlive.com/user/authenticate",
        ...
        final XblXstsResponse xstsRes = gson.fromJson(
                UtilBrowser.postExternal("https://xsts.auth.xboxlive.com/xsts/authorize",
        ...
        final McResponse mcRes = gson.fromJson(
                UtilBrowser.postExternal("https://api.minecraftservices.com/authentication/login_with_xbox",
        ...
        final GameOwnershipResponse gameOwnershipRes = gson.fromJson(
                UtilBrowser.getBearerResponse("https://api.minecraftservices.com/entitlements/mcstore", mcRes.access_token),
        ...
        final ProfileResponse profileRes = gson.fromJson(
                UtilBrowser.getBearerResponse("https://api.minecraftservices.com/minecraft/profile", mcRes.access_token),
    ...
    private static class Handler implements HttpHandler {
        ...
        private void handleCode(final String code) {
            ...
            final String response = UtilBrowser.postExternal("https://login.live.com/oauth20_token.srf",
